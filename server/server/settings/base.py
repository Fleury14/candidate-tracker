...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://postgres:@postgres:5432/server",
...
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "server.core.pagination.LinkedPagination",
...
DJOSER = {
    ...
    "PERMISSIONS": {
        "user_delete": ["server.users.permissions.IsAdmin"],
        "user_list": ["server.users.permissions.IsAdmin"],
    },
    "EMAIL": {
        "activation": "server.users.email.ActivationEmail",
        "password_reset": "server.users.email.PasswordResetEmail",
    },
    "SERIALIZERS": {
        "user": "server.users.serializers.UserSerializer",
        "user_delete": "rest_framework.serializers.Serializer",
        "token": "server.users.serializers.TokenSerializer",
        "user_create": "server.users.serializers.UserCreateSerializer",
        "current_user": "server.users.serializers.UserSerializer",
        "create_user": "server.users.serializers.UserCreateSerializer",
        "activation": "server.users.serializers.ActivationSerializer",
    },
}
