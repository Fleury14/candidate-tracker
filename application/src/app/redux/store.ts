...
import { candidateApi } from 'common/api/candidateApi';
...
export const createAppStore = (options?: ConfigureStoreOptions['preloadedState'] | undefined) =>
  configureStore({
    ...
    middleware: getDefaultMiddleware =>
      getDefaultMiddleware().concat(agentApi.middleware, authApi.middleware, userApi.middleware, candidateApi.middleware),
